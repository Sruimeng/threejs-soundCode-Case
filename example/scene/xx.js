...
`;
// debugger;
THREE.ShaderLib.physical.fragmentShader=THREE.ShaderChunk.meshphysical_frag;
...
void main() {
    ...
    vec3 rotated = rotateAroundYInDegrees(vec3( position ),-uRotation);
...
void main() {
    ...
    vec4 texColor = textureCube( tCube, vec3( tFlip * vWorldDirection.x, vWorldDirection.yz ),5.0);
